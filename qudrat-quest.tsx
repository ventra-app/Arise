...
QQ.registerLessons({
  F: {
    ...
    units: [
      ...
      { id: "f3", icon: "🔁", name: "كسر ↔ عشري ↔ نسبة", cards: [
      ...
      { id: "f4", icon: "🧮", name: "ترتيب العمليات", cards: [
      ...
      { id: "f5", icon: "➖", name: "الأعداد السالبة", cards: [
      ...
      { id: "f6", icon: "🔤", name: "لبنات الجملة الإنجليزية", cards: [
      ...
      { id: "f7", icon: "⏳", name: "الزمنان الأساسيان", cards: [
      ...
      { id: "f8", icon: "🗝️", name: "مفردات البداية", cards: [
  ...
  S: {
    ...
    units: [
      { id: "s1", icon: "٪", name: "النسبة المئوية خطوة بخطوة", cards: [
      ...
      { id: "s2", icon: "⚖️", name: "معادلة من خطوة واحدة", cards: [
      ...
      { id: "s3", icon: "📐", name: "الأشكال الأساسية", cards: [
      ...
      { id: "s4", icon: "📊", name: "المتوسط ببساطة", cards: [
      ...
      { id: "s5", icon: "🔗", name: "التناظر التدريبي", cards: [
      ...
      { id: "s6", icon: "✍️", name: "إكمال الجمل بإشارات واضحة", cards: [
  ...
  Q: {    id: "Q", name: "المرحلة الثالثة: القدرات", icon: "🧭", color: "#C89235",
    ...
    units: [
      { id: "q1", icon: "⏱", name: "إدارة وقت الاختبار", cards: [
      ...
      { id: "q2", icon: "✂️", name: "فن الحذف الذكي", cards: [
      ...
      { id: "q3", icon: "🗺️", name: "خريطة الاختبار وأنماطه", cards: [
...
function unitGenQs(unitId, n, g) {
  ...
  for (let t = 0; t < n * 6 && out.length < n; t++) {
    const cands = GENS.filter(x => (x.type || "mcq") === "mcq" && map.topics.includes(x.topic) && map.diffs.includes(x.diff));
    if (!cands.length) break;
    const q = makeGen(GR.pick(cands), g);
...
const ACADEMY = [QQ._lessons.F, QQ._lessons.S, PHASE_AWL, QQ._lessons.Q, QQ._lessons.P, QQ._lessons.C];
{
